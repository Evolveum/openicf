...
public class MapTransformParserFactory implements OutputParserFactory {
    public OutputParser createOutputParser(String parserDefinition) {
        return new MapTransformParser(parserDefinition);
    }
}
