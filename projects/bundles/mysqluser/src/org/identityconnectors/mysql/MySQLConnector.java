...
/**
 * The mysql {@link MySQLConnector} connector works with accounts in a mysql database.
 * <p>
 ...
 */
@ConnectorClass(
        displayNameKey = "mysql.connector.display",
        configurationClass = MySQLConfiguration.class) 
public class MySQLConnector implements PoolableConnector, CreateOp, SearchOp<FilterWhereBuilder>, DeleteOp, UpdateOp,
        SchemaOp, TestOp, AuthenticateOp {


    /**
     * Setup logging for the {@link MySQLConnector}.
     */
    private Log log = Log.getLog(MySQLConnector.class);
    
    /**
     * Place holder for the {@link Configuration} passed into the callback {@link MySQLConnector#init(Configuration)}.
     */
    ...
    public void init(Configuration cfg) {
        this.config = (MySQLConfiguration) cfg;
    ...
    /**
     * Disposes of the {@link MySQLConnector}'s resources.
     * 
    ...
    public FilterTranslator<FilterWhereBuilder> createFilterTranslator(ObjectClass oclass, OperationOptions options) {
        return new MySQLFilterTranslator(oclass, options);
    }

    /**
     * Runs a query generated by the MySQLFilterTranslator.
    ...
    public void executeQuery(ObjectClass oclass, FilterWhereBuilder where, ResultsHandler handler, OperationOptions options) {
        ...
        try {
            ...
            while (result.next()) {
                ...
                final String userName = result.getObject(MySQLConfiguration.MYSQL_USER).toString();                
