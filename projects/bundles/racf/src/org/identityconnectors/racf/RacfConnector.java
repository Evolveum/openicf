...
DeleteOp, SearchOp<String>, UpdateOp, SchemaOp, ScriptOnConnectorOp {
    ...
    public Schema schema() {
        ...
        // Required Attributes
        //
        attributes.add(AttributeInfoBuilder.build(Name.NAME,                    String.class, true));
        attributes.add(AttributeInfoBuilder.build(ATTR_DEFAULT_GROUP,           String.class, false));

        // Optional Attributes (have RACF default values)
        //
        attributes.add(AttributeInfoBuilder.build(ATTR_DATA,                    String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_MODEL,                   String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_OWNER,                   String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_PASSWORD,                String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_PROGRAMMER_NAME,         String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_DEFAULT_GROUP,           String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_SECURITY_LEVEL,          String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_SECURITY_CAT_LIST,       String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_REVOKE_DATE,             String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_RESUME_DATE,             String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_LOGON_DAYS,              String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_LOGON_TIME,              String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_CLASS_NAME,              String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_CONNECT_GROUP,           String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_SECURITY_LABEL,          String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_DPF_DATA_APP,            String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_DPF_DATA_CLASS,          String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_DPF_MGMT_CLASS,          String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_DPF_STORAGE_CLASS,       String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_TSO_ACCOUNT_NUMBER,      String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_TSO_DEFAULT_CMD,         String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_TSO_DESTINATION,         String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_TSO_MESSAGE_CLASS,       String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_TSO_DEFAULT_LOGIN,       String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_TSO_LOGIN_SIZE,          String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_TSO_MAX_REGION_SIZE,     String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_TSO_DEFAULT_SYSOUT,      String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_TSO_USERDATA,            String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_TSO_DEFAULT_UNIT,        String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_TSO_SECURITY_LABEL,      String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_LANG_PRIMARY,            String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_LANG_SECONDARY,          String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_CICS_OPER_ID,            String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_CICS_OPER_CLASS,         String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_CICS_OPER_PRIORITY,      String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_CICS_OPER_RESIGNON,      String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_CICS_TERM_TIMEOUT,       String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_OP_STORAGE,              String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_OP_AUTH,                 String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_OP_MFORM,                String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_OP_LEVEL,                String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_OP_MONITOR,              String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_OP_ROUTCODE,             String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_OP_LOG_CMD_RESPONSE,     String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_OP_MGID,                 String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_OP_DOM,                  String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_OP_KEY,                  String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_OP_CMDSYS,               String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_OP_UD,                   String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_OP_MSCOPE_SYSTEMS,       String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_OP_ALTGROUP,             String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_OP_AUTO,                 String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_WA_USER_NAME,            String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_WA_BUILDING,             String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_WA_DEPARTMENT,           String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_WA_ROOM,                 String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_WA_ADDRESS_LINE1,        String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_WA_ADDRESS_LINE2,        String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_WA_ADDRESS_LINE3,        String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_WA_ADDRESS_LINE4,        String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_WA_ACCOUNT_NUMBER,       String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_OMVS_UID,                String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_OMVS_HOME,               String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_OMVS_INIT_PROGRAM,       String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_OMVS_MAX_CPUTIME,        String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_OMVS_MAX_ADDR_SPACE,     String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_OMVS_MAX_FILES,          String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_OMVS_MAX_THREADS,        String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_OMVS_MAX_MEMORY_MAP,     String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_NV_NINITIALCMD,          String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_NV_DEFAULT_CONSOLE,      String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_NV_CTL,                  String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_NV_MESSAGE_RECEIVER,     String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_NV_OPERATOR_CLASS,       String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_NV_DOMAINS,              String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_NV_NGMFADM,              String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_NV_DCE_UUID,             String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_NV_DCE_PRINCIPAL,        String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_NV_DCE_HOME_CELL,        String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_NV_DCE_HOME_CELL_UUID,   String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_NV_DCE_AUTOLOGIN,        String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_OVM_UID,                 String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_OVM_HOME,                String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_OVM_INITIAL_PROGRAM,     String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_OVM_FILESYSTEM_ROOT,     String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_LN_SHORT_NAME,           String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_NDS_USER_NAME,           String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_KERB_NAME,               String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_KERB_MAX_TICKET_LIFE,    String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_KERB_ENCRYPT,            String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_PROXY_BINDDN,            String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_PROXY_BINDPW,            String.class, false));
        attributes.add(AttributeInfoBuilder.build(ATTR_PROXY_HOST,              String.class, false));
        ...
        groupAttributes.add(AttributeInfoBuilder.build(ATTR_DATA,               String.class, false));
        groupAttributes.add(AttributeInfoBuilder.build(ATTR_MODEL,              String.class, false));
        groupAttributes.add(AttributeInfoBuilder.build(ATTR_OWNER,              String.class, false));
        groupAttributes.add(AttributeInfoBuilder.build(ATTR_SUP_GROUP,          String.class, false));
        groupAttributes.add(AttributeInfoBuilder.build(ATTR_TERM_UACC,          String.class, false));
        groupAttributes.add(AttributeInfoBuilder.build(ATTR_UNIVERSAL,          String.class, false));
        groupAttributes.add(AttributeInfoBuilder.build(ATTR_DPF_DATA_APP,       String.class, false));
        groupAttributes.add(AttributeInfoBuilder.build(ATTR_DPF_DATA_CLASS,     String.class, false));
        groupAttributes.add(AttributeInfoBuilder.build(ATTR_DPF_MGMT_CLASS,     String.class, false));
        groupAttributes.add(AttributeInfoBuilder.build(ATTR_DPF_STORAGE_CLASS,  String.class, false));
