...
abstract class DB2Messages {
    ...
    static final String NULL = "db2.null";
    static final String NOT_NULL = "db2.notNull";
    static final String BLANK = "db2.blank";
    static final String NOT_BLANK = "db2.notBlank";
