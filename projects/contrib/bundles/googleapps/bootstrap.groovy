...
//static properties
static final String BUNDLE_NAME = "Connector-GoogleApps";
static final String BUNDLE_VERSION = "1.0.0.0"; 
static final String BUNDLE_JAR_PATH = "/Users/warrenstrange/src/java/Connector-GoogleApps/dist";
static final String CONNECTOR_CLASS = "org.identityconnectors.googleapps.GoogleAppsConnector"
...
for(String propName : propertyNames) {
    ...
    System.out.println("PropertyName: " + prop.getName() + "        PropertyType: " + prop.getType() + " val=" + prop.getValue());
