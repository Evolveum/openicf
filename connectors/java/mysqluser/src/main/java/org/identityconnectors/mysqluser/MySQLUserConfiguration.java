...
import static org.identityconnectors.mysqluser.MySQLUserConstants.DEFAULT_DRIVER;
import static org.identityconnectors.mysqluser.MySQLUserConstants.DEFAULT_PORT;
import static org.identityconnectors.mysqluser.MySQLUserConstants.DEFAULT_USER_MODEL;
import static org.identityconnectors.mysqluser.MySQLUserConstants.EMPTY_STR;
import static org.identityconnectors.mysqluser.MySQLUserConstants.MSG_HOST_BLANK;
import static org.identityconnectors.mysqluser.MySQLUserConstants.MSG_JDBC_DRIVER_BLANK;
import static org.identityconnectors.mysqluser.MySQLUserConstants.MSG_JDBC_DRIVER_NOT_FOUND;
import static org.identityconnectors.mysqluser.MySQLUserConstants.MSG_PASSWORD_BLANK;
import static org.identityconnectors.mysqluser.MySQLUserConstants.MSG_PORT_BLANK;
import static org.identityconnectors.mysqluser.MySQLUserConstants.MSG_USER_BLANK;
import static org.identityconnectors.mysqluser.MySQLUserConstants.MSG_USER_MODEL_BLANK;
...
public class MySQLUserConfiguration extends AbstractConfiguration {
    ...
    private static final String URL_TEMPLATE = "jdbc:mysql://{0}:{1}/mysql";
     ...
     */
    @ConfigurationProperty(order = 1, helpMessageKey = "MYSQL_DATASOURCE_HELP",
            displayMessageKey = "MYSQL_DATASOURCE_DISLPAY")
    ...
    /**
     * The jndiFactory array of properties setting is used to connect to
     * database in server environment.
     */
     ...
     */
    @ConfigurationProperty(order = 2, helpMessageKey = "MYSQL_JNDI_PROPERTIES_HELP",
            displayMessageKey = "MYSQL_JNDI_PROPERTIES_DISPLAY")
     ...
     *            an array of <CODE>String</CODE>'s JndiProperties values
     */
     ...
     */
    @ConfigurationProperty(order = 4, helpMessageKey = "MYSQL_DRIVER_HELP",
            displayMessageKey = "MYSQL_DRIVER_DISPLAY")
     ...
     *
     * @param driver
     *            the <CODE>String</CODE> jdbc class name value
     */
     ...
     */
    @ConfigurationProperty(order = 5, helpMessageKey = "MYSQL_HOST_HELP",
            displayMessageKey = "MYSQL_HOST_DISPLAY")
     ...
     */
    @ConfigurationProperty(order = 6, helpMessageKey = "MYSQL_USER_HELP",
            displayMessageKey = "MYSQL_USER_DISPLAY")
     ...
     */
    @ConfigurationProperty(order = 7, helpMessageKey = "MYSQL_PWD_HELP",
            displayMessageKey = "MYSQL_PWD_DISPLAY", confidential = true)
     ...
     *
     * @param password
     *            a <CODE>GuardedString</CODE> passport object
     */
     ...
     */
    @ConfigurationProperty(order = 8, helpMessageKey = "MYSQL_PORT_HELP",
            displayMessageKey = "MYSQL_PORT_DISPLAY")
     ...
     */
    @ConfigurationProperty(order = 9, required = true, helpMessageKey = "MYSQL_USERMODEL_HELP",
            displayMessageKey = "MYSQL_USERMODEL_DISPLAY")
