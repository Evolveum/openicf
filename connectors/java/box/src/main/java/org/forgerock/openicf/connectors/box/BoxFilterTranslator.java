 ...
 *
 * If the Box doesn't support a certain expression type, that factory
...
public class BoxFilterTranslator extends AbstractFilterTranslator<String> {
    ...
    public BoxFilterTranslator(ObjectClass objectClass) {
    ...
    protected String createLessThanOrEqualExpression(LessThanOrEqualFilter filter, boolean not) {
        throw new InvalidAttributeValueException("Filter 'LessThanOrEqualFilter' is not supported.");
    }
}
