...
public class OracleCaseSensitivitySetupTest {
    ...
    public void testCreateExplicitFormatters(){
        ...
        AssertJUnit.assertEquals("AAA",cs.getAttributeFormatterAndNormalizer(OracleUserAttribute.ROLE).getQuatesChar());
    ...
    public void testCreateExplicitNormalizers(){
        ...
        AssertJUnit.assertTrue(cs.getAttributeFormatterAndNormalizer(OracleUserAttribute.ROLE).isToUpper());
    ...
    public void testCreateAllFormatters(){
        ...
        for(OracleUserAttribute oua : OracleUserAttribute.values()){
            AssertJUnit.assertNotNull("Formatter for attribute " + oua + " cannot be null", cs.getAttributeFormatterAndNormalizer(oua));
        }
    }
    ...
    public void testCreateAllNormalizers(){
        ...
        for(OracleUserAttribute oua : OracleUserAttribute.values()){
            AssertJUnit.assertNotNull("Normalizer for attribute " + oua + " cannot be null", cs.getAttributeFormatterAndNormalizer(oua));
        }
    }
    ...
    public void testCreateFromFormat(){
    	...
    	for(OracleUserAttribute oua : OracleUserAttribute.values()){
    		AssertJUnit.assertNotNull("Formatter for all attributes muts be defined", setup.getAttributeFormatterAndNormalizer(oua));
    	}
        try{
        ...
        AssertJUnit.assertEquals("\"",cs.getAttributeFormatterAndNormalizer((OracleUserAttribute.DEF_TABLESPACE)).getQuatesChar());
        AssertJUnit.assertEquals("AAA",cs.getAttributeFormatterAndNormalizer((OracleUserAttribute.USER)).getQuatesChar());
        AssertJUnit.assertEquals(true,cs.getAttributeFormatterAndNormalizer(OracleUserAttribute.USER).isToUpper());
        AssertJUnit.assertEquals(true,cs.getAttributeFormatterAndNormalizer(OracleUserAttribute.ROLE).isToUpper());
        AssertJUnit.assertEquals("\"",cs.getAttributeFormatterAndNormalizer((OracleUserAttribute.ROLE)).getQuatesChar());
    ...
    public void testCreateFromArray(){
    	...
    	AssertJUnit.assertEquals("AAA",setup.getAttributeFormatterAndNormalizer((OracleUserAttribute.USER)).getQuatesChar());
    	AssertJUnit.assertEquals("BBB",setup.getAttributeFormatterAndNormalizer((OracleUserAttribute.ROLE)).getQuatesChar());
    	AssertJUnit.assertEquals(false,setup.getAttributeFormatterAndNormalizer((OracleUserAttribute.ROLE)).isToUpper());
