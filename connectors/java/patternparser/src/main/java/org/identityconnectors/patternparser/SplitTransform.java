...
/**
 * A SplitTransform specifies a pattern to be used to split the value into a
 * List&lt;String&gt;.
 * <p>
 ...
 * </pre>
 */
public class SplitTransform extends Transform<List<String>> {
    private static final String SPLIT_PATTERN = "splitPattern";
    private Pattern splitPattern;

    protected String getAttributes() {
        return super.getAttributes() + attributeToString(SPLIT_PATTERN, splitPattern.pattern());
    }
     ...
     *
     * @param splitPattern
     *            a pattern to be used to split strings into subStrings.
     */
    ...
    /**
     * Convert <b>input</b> into a String, and split the string into separate
     * strings, based on the <b>splitPattern</b> specified in the constructor.
     *
     * @param input
     *            the object to be transformed
     * @return a List&lt;String&gt; containing the substrings split from the
     *         input
     */
    @Override
