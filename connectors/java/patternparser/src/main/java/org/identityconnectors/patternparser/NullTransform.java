...
/**
 * A NullTransform specifies a string to be used in a match. If the input
 * matches the pattern, a null is returned, otherwise the input is returned.
 */
public class NullTransform extends Transform<Object> {
