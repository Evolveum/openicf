 ...
 * </pre>
 */
public class BooleanTransform extends Transform<Object> {
    /**
    ...
    /**
     * Convert <b>input</b> into a String, and if the String equals (ignoring
     * case) "true" return a Boolean.TRUE. If the String equals (ignoring case)
     * "false" return a Boolean.FALSE. Otherwise, just return the input object.
     *
     * @param input
