...
public class CaseNormalizer implements AttributeNormalizer {
    ...
    private static final Log LOG = Log.getLog(CaseNormalizer.class);

    public Attribute normalizeAttribute(ObjectClass oclass, Attribute attribute) {
//        LOG.ok("Starting CaseNormalizer.normalizeAttribute({0}, {1}={2})", oclass, attribute.getName(), attribute.getValue());
...
//        LOG.ok("Finishing CaseNormalizer.normalizeAttribute, converted = {0}, return value = {1}={2}", converted, rv.getName(), rv.getValue());
        return rv;
    }
}
